...
#define REGISTER_SCRIPTED_CLASS( nameSpace, className, storeCopy, instanciationAllowed ) \
	...
	template<> \
	struct StoragePolicy<nameSpace##::##className##> \
	{ enum { Value = storeCopy }; }; \
	template<> \
	struct InstanciationPolicy<nameSpace##::##className##> \
...
#define REGISTER_SCRIPTED_CLASS_METHOD0( nameSpace, className, methodName, returnType, isConst ) \
	...
	CMethodDescriptor< nameSpace##::##className##, returnType, Void, Void, Void, isConst >	nameSpace##_##className##_##methodName##( & nameSpace##_##className.MethodList, nameSpace##_##className##_##methodName##_name, & nameSpace##::##className##::##methodName##  ); \

#define REGISTER_SCRIPTED_CLASS_METHOD1( nameSpace, className, methodName, returnType, arg1, isConst ) \
	char nameSpace##_##className##_##methodName##_name[] = #methodName;\
	CMethodDescriptor< nameSpace##::##className##, returnType, arg1, Void, Void, isConst >	nameSpace##_##className##_##methodName##( & nameSpace##_##className.MethodList, nameSpace##_##className##_##methodName##_name, & nameSpace##::##className##::##methodName##  ); \

#define REGISTER_SCRIPTED_CLASS_METHOD2( nameSpace, className, methodName, returnType, arg1, arg2, isConst ) \
	char nameSpace##_##className##_##methodName##_name[] = #methodName;\
	CMethodDescriptor< nameSpace##::##className##, returnType, arg1, arg2, Void, isConst >	nameSpace##_##className##_##methodName##( & nameSpace##_##className.MethodList, nameSpace##_##className##_##methodName##_name, & nameSpace##::##className##::##methodName##  ); \

#define REGISTER_SCRIPTED_CLASS_METHOD3( nameSpace, className, methodName, returnType, arg1, arg2, arg3, isConst ) \
	char nameSpace##_##className##_##methodName##_name[] = #methodName;\
	CMethodDescriptor< nameSpace##::##className##, returnType, arg1, arg2, arg3, isConst >	nameSpace##_##className##_##methodName##( & nameSpace##_##className.MethodList, nameSpace##_##className##_##methodName##_name, & nameSpace##::##className##::##methodName##  ); \
